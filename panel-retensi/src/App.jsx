...
const SP_COLORS = ["oklch(0.74 0.09 160)","oklch(0.8 0.11 78)","oklch(0.72 0.14 45)","oklch(0.68 0.15 25)","oklch(0.55 0.16 20)"];
const SP_LABELS = ["Aman","SP1 terkirim","SP2 — eskalasi","SP3 — dibekukan","Diblokir + refund"];
...
export default function App() {
  ...
  useEffect(() => {
    ...
    const tick = setInterval(() => {
      ...
      const nextOrders = ordersRef.current.map(o => {
